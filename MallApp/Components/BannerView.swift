...
class BannerView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    // MARK: - Constants
    private static let cellId = "bannerID"
    private static let convertViewTag = 10086
    ...
    override init(frame: CGRect) {
        ...
        flowLayout.configureForHorizontalScroll()
    ...
    private func setupViews() {
        collectionView.configureForBannerView()
    ...
    private func setupDataSource() {
        pageControl.numberOfPages = dataSource?.numberOfBanners(self) ?? 0
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let view = cell.contentView.viewWithTag(BannerView.convertViewTag) {
            ...
            let new = dataSource.viewForBanner(self, index: index, convertView: nil)
            new.tag = BannerView.convertViewTag
...
private extension UICollectionViewFlowLayout {
    func configureForHorizontalScroll() {
